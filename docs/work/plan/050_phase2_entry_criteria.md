...
- Verified by compile/build evidence and evidence chain:
  - `docs/work/diag/evidence/<timestamp>/build/build_luce_core_stage0.txt`
  - `docs/work/diag/evidence/<timestamp>/build/build_luce_core_stage4.txt`
  - `docs/work/diag/evidence/<timestamp>/lint/platformio_check_luce_core_stage0.txt`
  - `docs/work/diag/evidence/<timestamp>/lint/platformio_check_luce_core_stage4.txt`
...
- Evidence snapshot must include:
  - upload success log (`docs/work/diag/evidence/<timestamp>/upload/luce_core_upload.txt`)
  - boot artifact (`docs/work/diag/evidence/<timestamp>/boot/boot_luce_core.txt`)
  - CLI-session baseline (`docs/work/diag/evidence/<timestamp>/e2e/cli_core_session.txt`).
...
- [ ] Stage matrix evidence confirms compile integrity for stage0..4.
  - Proof: `docs/work/diag/evidence/<timestamp>/build/build_luce_core_stage0.txt`, `docs/work/diag/evidence/<timestamp>/build/build_luce_core_stage4.txt`
...
- [ ] Minimum viable test set executed.
  - Proof: `docs/work/diag/evidence/<timestamp>/unit/unit_native.txt`, `docs/work/diag/evidence/<timestamp>/boot/boot_luce_core.txt`, `docs/work/diag/evidence/<timestamp>/e2e/cli_core_session.txt`
